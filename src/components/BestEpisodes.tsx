...
import { Heart } from 'lucide-react'; // swapped from List to Heart
    ...
    <section id="best" className="py-20 bg-black">
      <div className="container px-6">
        <div className="mb-12 text-center">
          ...
          <h2 className="text-4xl md:text-5xl mb-4 text-podcast-magenta transform scale-x-120"> 
            פרקים נבחרים
          </h2>
          ...
          {bestEpisodes.map((episode, index) => (
            <Card key={index} className="relative bg-podcast-darkgray/30 border-white/10 hover:border-podcast-magenta/50 transition-all duration-300 overflow-hidden">
              <CardContent className="p-0 relative">
                ...
                <div className="p-6">
                <h3 className="text-3xl font mb-3 text-podcast-magenta transform scale-x-110 inline-block origin-right">
                    {episode.title}
                  </h3>
