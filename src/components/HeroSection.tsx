    ...
    <section className="relative min-h-screen flex items-center pt-24 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-16 md:py-32 relative z-10 flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div className="max-w-3xl mx-auto md:mx-0 flex-1 w-full">
          <h1
            className="text-4xl md:text-6xl lg:text-7xl mb-8 text-center font-display font-bold bg-gradient-to-r from-white via-podcast-yellow to-podcast-magenta bg-clip-text text-transparent transform origin-center inline-block opacity-0 animate-fade-in-delay-1"
          >
