...
const AboutSection = () => {
  const hosts = [
    ...
    },
    {
      name: "יהונתן כהן",
      pronouns: "(היא/הוא)",
      bio: "יהונתן היא מנהלת מוצר המתמחה בהובלת פתרונות דיגיטליים מורכבים המבוססים על טכנולוגיות AI וניתוח נתונים מתקדם. יש לו תואר ראשון בקוגניציה ובפסיכולוגיה מהאוניברסיטה העברית בירושלים.",
      image: "/yehonatan.jpg",
      social: {
      ...
      <div className="container px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-white/80 mb-4">
            ...
            בין סיפורי הילדות, טיולים ברחבי העולם ודייטים כושלים, “אחותי היפה” מדבר אל הלב ומציע נקודת מבט ייחודית על פגיעות, שייכות, ואהבה.
          </p>
